...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['question_text'])) {
    ...
    if ($question_text !== '') {
        $insert_sql = "INSERT INTO questions (examination_id, text) VALUES (?, ?)";
        $insert_stmt = $conn->prepare($insert_sql);
        $insert_stmt->bind_param("is", $exam_id, $question_text);
        $insert_stmt->execute();
        $insert_stmt->close();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Examination: <?php echo htmlspecialchars($exam['title']); ?></h1>
                    </div>
